...
var SimpleSubStore = function () {
  function SimpleSubStore(initialValue, key, parent) {
    var depth = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0;

    _classCallCheck(this, SimpleSubStore);

    this.prevState = {};

    if (depth > 100) {
      SimpleSubStore.__kill();
    }
    this._depth = depth;
    this._id = key;
    this._parent = parent;
  ...
  _createClass(SimpleSubStore, [{
    ...
    key: 'clearState',
    value: function clearState(newValue) {
      if (this._parent) {
        var prevState = this.state;
      ...
      if (nextState instanceof Object) {
        if (prevState instanceof Object) {
          ...
          for (var _k in nextState) {
            this[_k] = new SimpleSubStore(nextState[_k], _k, this, this._depth + 1);
          }
        }
    ...
    key: '_getChildrenRecursively',
    value: function _getChildrenRecursively() {
      return this.children().reduce(function (acc, child) {
        acc.push(child);
        return [].concat(_toConsumableArray(acc), _toConsumableArray(child._getChildrenRecursively()));
      }, []);
    }
  }, {
    key: '_onDetach',
  ...
  return SimpleSubStore;
}();

exports.default = SimpleSubStore;