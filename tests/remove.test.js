...
describe('remove', () => {
  ...
  test('should be able to remove an empty child',
    () => {
      const { subject }= createStoreWithNonedux({ a: 1, b: { c: 2, d: 3, e: { f: 4, g: 7, h: { i: 100, x: {}, j: { z: -0, }, }, }, }, });
      subject.b.e.h.remove([ 'x', ]);
      expect(subject.state).toEqual({ a: 1, b: { c: 2, d: 3, e: { f: 4, g: 7, h: { i: 100, j: { z: -0, }, }, }, }, });
    });
  ...
  test('should be able to remove undefined value',
    () => {
      const { subject }= createStoreWithNonedux({ a: 1, b: { c: undefined, d: undefined, e: { f: 4, g: 7, }, }, });
      subject.b.remove([ 'd', ]);
