...
describe('setState', () => {
  ...
  test('undefined leaf to object', () => {
    subject = nonedux({ a: 1, b: 'hello', c: { d: undefined, }, }).subject;
  ...
  test('undefined leaf to string', () => {
    subject = nonedux({ a: 1, b: { c: undefined, d: 3, e: { f: 4, g: 7, h: { i: 100, x: {}, }, }, }, }).subject;
  ...
  test('setState with a  primitive should throw error', () => {
    subject = nonedux({ a: 1, b: { c: undefined, d: 3, e: { f: 4, }, }, }).subject;
    expect(() => subject.b._onSetState(2)).toThrow(Error);
  });

  test('immidiate string to empty object', () => {
    subject = nonedux({ a: 'hello', b: { c: undefined, d: 3, e: { f: 4, }, }, }).subject;
    subject._onSetState({ a: {}, });
  ...
  test('non immidiate string to empty object', () => {
    subject = nonedux({ b: { c: 'hello', d: 3, e: { f: 4, }, }, }).subject;
