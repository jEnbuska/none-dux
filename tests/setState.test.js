...
describe('setState', () => {
  ...
  test('add a new values', () => {
    const { subject: { root, }, }= createStoreWithNonedux({ root: { a: 1, b: { c: 2, d: 3, e: { f: 4, }, }, }, });
    root.setState({ x: 1, });
  ...
  test('undefined leaf to object', () => {
    const { subject: { root, }, }= createStoreWithNonedux({ root: { a: 1, b: 'hello', c: { d: undefined, }, }, });
  ...
  test('undefined leaf to string', () => {
    const { subject: { root, }, }= createStoreWithNonedux({ root: { a: 1, b: { c: undefined, d: 3, e: { f: 4, g: 7, h: { i: 100, x: {}, }, }, }, }, });
