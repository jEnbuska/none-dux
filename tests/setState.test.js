...
describe('setState', () => {
  ...
  test('undefined leaf to object', () => {
    subject = new ReducerParent({ a: 1, b: 'hello', c: { d: undefined, }, });
  ...
  test('undefined leaf to string', () => {
    subject = new ReducerParent({ a: 1, b: { c: undefined, d: 3, e: { f: 4, g: 7, h: { i: 100, x: {}, }, }, }, });
  ...
  test('setState with a  primitive should throw error', () => {
    subject = new ReducerParent({ a: 1, b: { c: undefined, d: 3, e: { f: 4, }, }, });
    expect(() => subject.b._onSetState(2)).toThrow(Error);
  });

  test('immidiate string to empty object', () => {
    subject = new ReducerParent({ a: 'hello', b: { c: undefined, d: 3, e: { f: 4, }, }, });
    subject._onSetState({ a: {}, });
  ...
  test('non immidiate string to empty object', () => {
    subject = new ReducerParent({ b: { c: 'hello', d: 3, e: { f: 4, }, }, });
