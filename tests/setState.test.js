...
describe('setState', () => {
  ...
  test('add a new values', () => {
    subject = createStoreWithNonedux({ a: 1, b: { c: 2, d: 3, e: { f: 4, }, }, });
...
*/
  ...
  test('undefined leaf to object', () => {
    subject = createStoreWithNonedux({ a: 1, b: 'hello', c: { d: undefined, }, });
  ...
  test('undefined leaf to string', () => {
    subject = createStoreWithNonedux({ a: 1, b: { c: undefined, d: 3, e: { f: 4, g: 7, h: { i: 100, x: {}, }, }, }, });
  ...
  test('setState with a  primitive should throw error', () => {
    subject = createStoreWithNonedux({ a: 1, b: { c: undefined, d: 3, e: { f: 4, }, }, });
    expect(() => subject.b.setState(2)).toThrow(Error);
  });

  test('immidiate string to empty object', () => {
    subject = createStoreWithNonedux({ a: 'hello', b: { c: undefined, d: 3, e: { f: 4, }, }, });
    subject.setState({ a: {}, });
  ...
  test('non immidiate string to empty object', () => {
    subject = createStoreWithNonedux({ b: { c: 'hello', d: 3, e: { f: 4, }, }, });
