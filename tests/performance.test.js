import { createStoreWithNonedux as init, createReduxStore, } from './utils';
...
describe('performance', () => {
  ...
  test('create and access lot of children', () => {
    ...
    console.log('create and access 132 000 children: ', new Date() - time, 'ms');
  }, 15000);
  ...
  test('remove children semi', () => {
    ...
    console.log('Remove 3000 children semi performance. Took total of: ', new Date() - time, 'ms');
  }, 15000);
  ...
  test('redux comparison', () => {
    ...
    initialState.G = data;
    initialState.H = data;
    const { subject, } = init(initialState);
